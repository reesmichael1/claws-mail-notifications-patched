# $Id$
# Maintainer: Michael Rees <reesmichael1@vivaldi.net>
...
sha256sums=('c212133d3d962129d8c7995c1c7d973faef2a8914481c0c74578217bf4c897ab'
            ...
            'fdc1124c0c80318f2f9b893969b49e588dd2bef21efa009c529f22764e643308')
...
prepare() {
  ...
  # patch -Np1 -i ../fix_notification_plugin.diff < "${srcdir}/fix_notification_plugin.patch"
  patch -Np1 -i ../fix_notification_plugin.diff < "${srcdir}/fix_notification_plugin.diff"
